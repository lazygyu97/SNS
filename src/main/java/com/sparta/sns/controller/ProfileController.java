...
public class ProfileController {
    ...
    public ResponseEntity<ApiResponseDto> modifyProfile(@AuthenticationPrincipal UserDetailsImpl userDetails, @RequestBody ProfileRequestDto requestDto, BindingResult bindingResult){
        //validation 예외처리
